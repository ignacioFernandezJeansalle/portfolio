export const INDUSTRIAL_WORKS = [
  ...
  },
  {
    ...
    tasks: [
      `Gestión del <span class="text-emphasis">departamento de programación</span>.`,
      "Personas a cargo: 6.",
  ...
  },
  {
    ...
    tasks: [
      ...
      `Desarrollé <span class="text-emphasis">protocolos de ensayos</span> obteniendo casos de éxito de impacto en puesta en producción de 0hs.`,
    ],
  },
  {
